...
const Header = () => {
    return (
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              ...
              <li><NavLink to={"/appliedjobs"}>Contact</NavLink></li>
              <li><NavLink to={"/blogs"}>Contact</NavLink></li>
        ...
        <div className="navbar-end">
          <Link to={"/login"} className="flex items-center bg-common rounded-lg text-lg"><LuLogIn className="mr-2" />LogIn</Link>
        </div>
      </div>
        </div>
    );
